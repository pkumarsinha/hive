...
public class TestReplicationScenariosExternalTables extends BaseReplicationAcrossInstances {
  ...
  public void replicationWithTableNameContainsKeywords() throws Throwable {
    ...
    WarehouseInstance.Tuple tuple = primary
            ...
            .run("create external table t3_functions (id int)")
            .run("insert into table t3_functions values (1)")
            .run("create external table t4_functions (id int)")
            .run("insert into table t4_functions values (1)")
            .run("create external table t5_functions (id int)")
            .run("insert into table t5_functions values (1)")
            .run("create external table t6_functions (id int)")
            .run("insert into table t6_functions values (1)")
            .run("create external table t7_functions (id int)")
            .run("insert into table t7_functions values (1)")
            .run("create external table t8_functions (id int)")
            .run("insert into table t8_functions values (1)")
            .run("create external table t9_functions (id int)")
            .run("insert into table t9_functions values (1)")
            .run("create external table t10_functions (id int)")
            .run("insert into table t10_functions values (1)")
            .dump(primaryDbName);
